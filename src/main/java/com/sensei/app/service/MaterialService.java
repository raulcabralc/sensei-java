...
public class MaterialService {
    ...
    public MaterialService(MaterialRepository materialRepository, ClassRepository classRepository, UserRepository userRepository) {
    ...
    public MaterialResponseDTO createMaterial(CreateMaterialDTO materialDTO)
        ...
        try {
            ...
            User teacher = this.userRepository.findById(material.getTeacherId())
                    .orElseThrow(() -> new TeacherDoesNotExistException("The teacher " + material.getTeacherId() + " does not exist"));
